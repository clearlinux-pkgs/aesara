...
Version  : 2.7.5
Release  : 26
URL      : https://files.pythonhosted.org/packages/4b/ad/d438add854091803c64bcc4bdf3b97ca07bd26396b98253b9074fb8af61d/aesara-2.7.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/4b/ad/d438add854091803c64bcc4bdf3b97ca07bd26396b98253b9074fb8af61d/aesara-2.7.5.tar.gz
...
%prep
%setup -q -n aesara-2.7.5
cd %{_builddir}/aesara-2.7.5
pushd ..
cp -a aesara-2.7.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657113681
...
cp %{_builddir}/aesara-2.7.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.5/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
