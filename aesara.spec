...
Version  : 2.7.1
Release  : 21
URL      : https://files.pythonhosted.org/packages/28/3f/401e369bd274ea5e73ce7c9c33cc29f943256fdfb7baa7f69197e95f29fe/aesara-2.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/28/3f/401e369bd274ea5e73ce7c9c33cc29f943256fdfb7baa7f69197e95f29fe/aesara-2.7.1.tar.gz
...
%prep
%setup -q -n aesara-2.7.1
cd %{_builddir}/aesara-2.7.1
pushd ..
cp -a aesara-2.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654380897
...
cp %{_builddir}/aesara-2.7.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.1/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
