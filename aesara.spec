...
Version  : 2.8.3
Release  : 36
URL      : https://files.pythonhosted.org/packages/9e/83/93c6195cdf1aaef847836da42a9603e8cacfe064f91358f10b35e7e7b3cf/aesara-2.8.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/9e/83/93c6195cdf1aaef847836da42a9603e8cacfe064f91358f10b35e7e7b3cf/aesara-2.8.3.tar.gz
...
%prep
%setup -q -n aesara-2.8.3
cd %{_builddir}/aesara-2.8.3
pushd ..
cp -a aesara-2.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663165068
