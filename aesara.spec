...
Version  : 2.7.6
Release  : 27
URL      : https://files.pythonhosted.org/packages/93/2d/322003e74a5708098fc1622a830b66ff674ead297dc5428c7d0ead1615b2/aesara-2.7.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/93/2d/322003e74a5708098fc1622a830b66ff674ead297dc5428c7d0ead1615b2/aesara-2.7.6.tar.gz
...
%prep
%setup -q -n aesara-2.7.6
cd %{_builddir}/aesara-2.7.6
pushd ..
cp -a aesara-2.7.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657633808
...
cp %{_builddir}/aesara-2.7.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.6/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
