...
Version  : 2.5.3
Release  : 12
URL      : https://files.pythonhosted.org/packages/25/d5/22aee214466a0cc8d534fc70016cdde9960754f342c48d8ece45cbebdaf9/aesara-2.5.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/25/d5/22aee214466a0cc8d534fc70016cdde9960754f342c48d8ece45cbebdaf9/aesara-2.5.3.tar.gz
...
%prep
%setup -q -n aesara-2.5.3
cd %{_builddir}/aesara-2.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647613092
...
cp %{_builddir}/aesara-2.5.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.5.3/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
