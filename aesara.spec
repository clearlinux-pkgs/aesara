...
Version  : 2.7.8
Release  : 29
URL      : https://files.pythonhosted.org/packages/3e/1d/43a7625425bc1d0b9bd20349407b9d68b173dfd301abd194bd15b570f8fa/aesara-2.7.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/1d/43a7625425bc1d0b9bd20349407b9d68b173dfd301abd194bd15b570f8fa/aesara-2.7.8.tar.gz
...
%prep
%setup -q -n aesara-2.7.8
cd %{_builddir}/aesara-2.7.8
pushd ..
cp -a aesara-2.7.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658412636
...
cp %{_builddir}/aesara-2.7.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.8/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
