...
Version  : 2.6.4
Release  : 17
URL      : https://files.pythonhosted.org/packages/96/30/975f31a2ad93c8316e06fcb001a589ba021e8c9aa16867c1cddc98cf0d2a/aesara-2.6.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/96/30/975f31a2ad93c8316e06fcb001a589ba021e8c9aa16867c1cddc98cf0d2a/aesara-2.6.4.tar.gz
...
%prep
%setup -q -n aesara-2.6.4
cd %{_builddir}/aesara-2.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650844081
...
cp %{_builddir}/aesara-2.6.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.6.4/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
