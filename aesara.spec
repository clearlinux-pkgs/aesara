...
Version  : 2.7.7
Release  : 28
URL      : https://files.pythonhosted.org/packages/0a/f4/fa24efc216e7dd811878cafaf3caecf6cd05410313db5d005ee3ef541f4d/aesara-2.7.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/0a/f4/fa24efc216e7dd811878cafaf3caecf6cd05410313db5d005ee3ef541f4d/aesara-2.7.7.tar.gz
...
%prep
%setup -q -n aesara-2.7.7
cd %{_builddir}/aesara-2.7.7
pushd ..
cp -a aesara-2.7.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657654514
...
cp %{_builddir}/aesara-2.7.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.7/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
