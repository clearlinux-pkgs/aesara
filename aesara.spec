...
Version  : 2.3.6
Release  : 5
URL      : https://files.pythonhosted.org/packages/2a/43/0b4eea755448a470145e01ca34b23d1b2d1834c85be95c5bbf10080d85f1/aesara-2.3.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/2a/43/0b4eea755448a470145e01ca34b23d1b2d1834c85be95c5bbf10080d85f1/aesara-2.3.6.tar.gz
...
%prep
%setup -q -n aesara-2.3.6
cd %{_builddir}/aesara-2.3.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642692818
...
cp %{_builddir}/aesara-2.3.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.3.6/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
