...
Version  : 2.5.2
Release  : 11
URL      : https://files.pythonhosted.org/packages/0a/55/188ef7fff45682c36a075efdbbd4ee2e445be6c18f4a1e6cba4276204c47/aesara-2.5.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/0a/55/188ef7fff45682c36a075efdbbd4ee2e445be6c18f4a1e6cba4276204c47/aesara-2.5.2.tar.gz
...
%prep
%setup -q -n aesara-2.5.2
cd %{_builddir}/aesara-2.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647525193
...
cp %{_builddir}/aesara-2.5.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.5.2/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
