...
Version  : 2.7.0
Release  : 20
URL      : https://files.pythonhosted.org/packages/02/9d/757e682f3d5f5bdc3646bb3139ba27f7700045b3566b85ddf11bb4781e6f/aesara-2.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/02/9d/757e682f3d5f5bdc3646bb3139ba27f7700045b3566b85ddf11bb4781e6f/aesara-2.7.0.tar.gz
...
%prep
%setup -q -n aesara-2.7.0
cd %{_builddir}/aesara-2.7.0
pushd ..
cp -a aesara-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654266347
...
cp %{_builddir}/aesara-2.7.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.0/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
