...
Version  : 2.8.4
Release  : 37
URL      : https://files.pythonhosted.org/packages/5c/8e/000ba78653c64fc0f3021228877197830032f1f7041dd3d9ccb63142a5ac/aesara-2.8.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/5c/8e/000ba78653c64fc0f3021228877197830032f1f7041dd3d9ccb63142a5ac/aesara-2.8.4.tar.gz
...
%prep
%setup -q -n aesara-2.8.4
cd %{_builddir}/aesara-2.8.4
pushd ..
cp -a aesara-2.8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663190852
