...
Source0  : https://files.pythonhosted.org/packages/62/8e/9d3be3ba2bec5d4d59ca00728670338b29d784b231da7474c91766e408d4/aesara-2.8.9.tar.gz
...
%prep
%setup -q -n aesara-2.8.9
cd %{_builddir}/aesara-2.8.9
pushd ..
cp -a aesara-2.8.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668438060
