...
Version  : 2.6.6
Release  : 19
URL      : https://files.pythonhosted.org/packages/a2/e2/b276b566abc0e9311280c651e10253978adcc105417318018558c8530c3e/aesara-2.6.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/a2/e2/b276b566abc0e9311280c651e10253978adcc105417318018558c8530c3e/aesara-2.6.6.tar.gz
...
%prep
%setup -q -n aesara-2.6.6
cd %{_builddir}/aesara-2.6.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652191794
...
cp %{_builddir}/aesara-2.6.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.6.6/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
