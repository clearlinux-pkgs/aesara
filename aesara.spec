...
%prep
%setup -q -n aesara-2.7.3
cd %{_builddir}/aesara-2.7.3
pushd ..
cp -a aesara-2.7.3 buildavx2
popd
...
cp %{_builddir}/aesara-2.7.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.3/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
