...
Version  : 2.8.8
Release  : 42
URL      : https://files.pythonhosted.org/packages/dc/80/c0d7eccd68fe6cfdcdad12df1b8848332ce9722d00e3c2408fe0bbee3268/aesara-2.8.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/dc/80/c0d7eccd68fe6cfdcdad12df1b8848332ce9722d00e3c2408fe0bbee3268/aesara-2.8.8.tar.gz
...
%prep
%setup -q -n aesara-2.8.8
cd %{_builddir}/aesara-2.8.8
pushd ..
cp -a aesara-2.8.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667570135
