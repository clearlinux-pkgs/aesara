...
Version  : 2.7.4
Release  : 25
URL      : https://files.pythonhosted.org/packages/3f/44/65ffe2d64a2833f520479e7a3f727e0345480029b9d45865c96f1fb6807b/aesara-2.7.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/3f/44/65ffe2d64a2833f520479e7a3f727e0345480029b9d45865c96f1fb6807b/aesara-2.7.4.tar.gz
...
%prep
%setup -q -n aesara-2.7.4
cd %{_builddir}/aesara-2.7.4
pushd ..
cp -a aesara-2.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657031267
...
cp %{_builddir}/aesara-2.7.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.4/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
