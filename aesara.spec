...
Version  : 2.7.2
Release  : 22
URL      : https://files.pythonhosted.org/packages/79/f8/f0bad83a121044097ddb247d7e9cbb8fd738cd3f8aab91a65b1b446673b2/aesara-2.7.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/79/f8/f0bad83a121044097ddb247d7e9cbb8fd738cd3f8aab91a65b1b446673b2/aesara-2.7.2.tar.gz
...
%prep
%setup -q -n aesara-2.7.2
cd %{_builddir}/aesara-2.7.2
pushd ..
cp -a aesara-2.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655250937
...
cp %{_builddir}/aesara-2.7.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
cp %{_builddir}/aesara-2.7.2/doc/LICENSE.txt %{buildroot}/usr/share/package-licenses/aesara/6bd1ba47b8f18885eec96c7b3e851a77323ace0e
